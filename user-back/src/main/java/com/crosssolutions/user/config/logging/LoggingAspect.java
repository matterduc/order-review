package com.crosssolutions.user.config.logging;
...
import com.bycnit.lap.config.ConfigConstants;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(com.bycnit.lap.repository..*)" + " || within(com.bycnit.lap.service..*)" + " || within(com.bycnit.lap.web.rest..*)")
    ...
    public void logAfterThrowing(final JoinPoint joinPoint, final Throwable e) {
        if (env.acceptsProfiles(ConfigConstants.PROFILE_DEVELOPMENT)) {
